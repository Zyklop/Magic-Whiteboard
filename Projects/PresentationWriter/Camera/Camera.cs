...
namespace HSR.PresentationWriter.DataSources
{
    ...
    public class Camera
    {
        ...
        public readonly CameraProperties Properties;
        ...
        /// Properties like camera resolution</param>
        public Camera(CameraProperties properties = null)
        {
            if (properties == null)
            {
                properties = new StandardCameraProperties();
            }
            Properties = properties;
        }

        /// <summary>
        /// Stopps device</summary>
        ~Camera()
        {
            Stop();
        }
        ...
        public void Start()
        {
            ...
            mCapHwnd = NativeMethods.capCreateCaptureWindowA("WebCap", 0, 0, 0, Properties.Width, Properties.Height, 0, 0);
