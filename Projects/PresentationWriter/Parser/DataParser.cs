...
namespace HSR.PresWriter.PenTracking
{
    public class DataParser
    {
        ...
        {
            if(!(mapperType.IsAssignableFrom(typeof(AbstractPointMapper))))
                throw new ArgumentException("Mapper doesn't inherit form AbstractPointMapper");
            // Initialize Calibration Tools
        ...
        private void StartTracking(object sender, EventArgs e)
        {
            ...
            if (_mapperType == typeof(LinearMapper))
            {
            ...
            if (_mapperType == typeof(FineBarycentricMapper))
            {
